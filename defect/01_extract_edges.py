...
output_folder = '/home/allride/workspace/2021/Detection/dataset/tile_round1_train_20201231/edge_infos'
...
def extract_square_edge(src_file, out_file):
    ...
    edge_img = cv2.Canny(image, 80, 150).astype(np.bool)
...
if __name__ == '__main__':
    ...
    # pool.close()
    # pool.join()
    img_file = '240_134_t20201128105530907_CAM2.jpg'
    extract_square_edge(
        os.path.join(img_folder, img_file),
        img_file,
    )